...
export function ProjectsScreen({ projects, now, onEditProject, onProgressChange, onAddProject, ai }: Props) {
  return <FlatList
    data={projects}
    ...
    renderItem={({ item }) => <ProjectCard project={item} now={now} onEdit={onEditProject} onProgressChange={onProgressChange} ai={ai} />}
